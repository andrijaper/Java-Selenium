...
public class Registration {
    ...
    public void existingUserShouldntRegisterAgain() {
        ...
        Response response = registration.sendApiRequest(ApiConstants.HttpMethods.POST.getMethod(),
            "/auth" + ApiConstants.Endpoint.REGISTER,
            null,
            bodyJson);
        registration.checkStatusCode(response, ApiConstants.StatusAndCode.UNPROCESSABLE.getCode());
    ...
    public void methodNotAllowed() {
        ...
        bodyJson = JsonGenerator.generateJson(user);
        Response response = registration.sendApiRequest(ApiConstants.HttpMethods.PATCH.getMethod(),
            "/auth" + ApiConstants.Endpoint.REGISTER,
            null,
            bodyJson);
        registration.checkStatusCode(response, ApiConstants.StatusAndCode.METHOD_NOT_ALLOWED.getCode());
        registration.checkStatusMessage(response,
    ...
    public void invalidUrl() {
        ...
        bodyJson = JsonGenerator.generateJson(user);
        Response response = registration.sendApiRequest(ApiConstants.HttpMethods.POST.getMethod(),
            "/auth" + ApiConstants.Endpoint.REGISTER + "/auth" + ApiConstants.Endpoint.REGISTER,
            null,
            bodyJson);
        registration.checkStatusCode(response, ApiConstants.StatusAndCode.NOT_FOUND.getCode());
        registration.checkStatusMessage(response,
